    ...
    <div class="mainpanel">
        ...
        <div class="pageheader clearfix">
            <div class="col-md-12 no-icon no_padding">
                <h2>{{trans('general.add')}}</h2>
            </div>
        </div>
        <div class="contentpanel">
            <div class="form-page s_table">
                <div class="form-page-header">
                    <i class="icon-create-new"></i> {{trans('email.add_email_template')}}
                </div>
                @include('layouts.errors')
                <div class="form-page-content">
                    <div class="inner-content clearfix" data-ng-controller="EmailController as emailCtrl" data-ng-init="emailCtrl.fetchRules()">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" data-ng-class="{'has-error': errors.body.has}">
                                        ...
                                        <div class="col-md-10">
                                            <textarea  ui-tinymce="tinymceOptions" rows='14' class="form-control" data-ng-model="emailCtrl.email.body" data-validation-name="{{ trans('email.body') }}" name='body'></textarea>
