...
<div class="contentpanel s_table">
	<div class="form-page">
	<div class="form-page-header">
		<i class="icon-create-new"></i> {{trans('user.edit_roles')}}
	</div>
    @include('layouts.errors')
    <div class="form-page-content">
        <div class="inner-content clearfix" data-ng-controller="RoleController as roleCtrl" data-ng-init="roleCtrl.fetchUserRoleSingleInfo({{$id}})">
                ...
                <div class="col-md-6">
                   <div class="form-group" data-ng-class="{'has-error': errors.name.has}" >
	                ...
	                <div class="col-md-12 col-xs-12 col-sm-12 bottom text-right">
						<a href="{{url('userrole')}}" class="btn-default btn_wt_bg btn" onclick="goBack()">Cancel</a>								
