	...
	<div class="mainpanel">
		...
		<div class="contentpanel">
			...
			<div class="form-page-header">
				<i class="icon-create-new"></i> {{ trans('user.edit_collector') }}
			</div>
		   <div class="form-page-content">
			   <div class="inner-content clearfix" data-ng-controller="CollectorUserController as collectorCtrl" data-ng-init = "collectorCtrl.fetchCollectorSingleInfo({{$id}})">
			         ...
			         <div class="row">
		         		<div class="col-md-12">
                            <div class="form-group" data-ng-class="{'has-error': errors.name.has}">
                                ...
                                <div class="col-md-6">
                                     <input type="text" class="form-control" data-ng-model='collectorCtrl.Collector.name' data-validation-name="{{ trans('general.name') }}" name="name">
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.mobile_number.has}">
                                ...
                                <div class="col-md-6">
                                     <input type="text" class="form-control" data-validation-name="{{ trans('general.phone_number') }}" name="mobile_number" data-ng-model='collectorCtrl.Collector.mobile_number'>
						...
						<div class="col-md-12 col-xs-12 col-sm-12 bottom text-right">
							<a href="{{url('collector')}}" class="btn-default btn_wt_bg btn" onclick="goBack()">{{ trans('general.cancel') }}</a>								
