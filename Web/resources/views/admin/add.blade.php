...
<div class="pageheader clearfix">
	<div class="col-md-12 no-icon no_padding">
		<h2>{{trans('general.manage_admin')}}</h2>
	</div>
</div>
   <div class="contentpanel">
   	<div class="form-page s_table">
   		<div class="form-page-header">
			<i class="icon-create-new"></i> {{trans('user.add_admin')}}
		</div>
   @include('layouts.errors')
   <div class="form-page-content">
	   <div class="inner-content clearfix" data-ng-controller="AdminUserController as adminUserCtrl" data-ng-init = "adminUserCtrl.fetchAddformRules()">
	      <form method="post" data-base-validator data-ng-submit = "adminUserCtrl.save($event)" enctype="multipart/form-data">
	         {{ csrf_field() }}
		         	<div class="row">
		         		<div class="col-md-12">
                            <div class="form-group" data-ng-class="{'has-error': errors.name.has}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" data-validation-name="{{ trans('general.name') }}" data-ng-model='adminUserCtrl.adminUser.name' name="name">
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.mobile_number.has}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" data-validation-name="Phone Number" name="mobile_number" data-ng-model='adminUserCtrl.adminUser.mobile_number'>
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.email.has}">
                                ...
                                <div class="col-md-6">
                                    <input type="email" class="form-control" data-ng-model='adminUserCtrl.adminUser.email' data-validation-name="{{ trans('general.email') }}" name="email">
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.password.has}">
                                <div class="col-md-2">
                                    <label class="label-name">{{ trans('general.password') }}<span class="asterisk">*</span></label>
                                </div>
                                <div class="col-md-6">
                                    <input type="password" class="form-control" data-ng-model='adminUserCtrl.adminUser.password' data-validation-name="{{ trans('general.password') }}" name="password">
				...
				<div class="col-md-12 col-xs-12 col-sm-12 bottom text-right">
					<a href="{{url('admin')}}" class="btn-default btn_wt_bg btn" onclick="goBack()">{{trans('general.cancel')}}</a>								
