	...
	<div class="mainpanel">
		...
		<div class="contentpanel">
			...
			<div class="form-page-header">
				<i class="icon-create-new"></i> {{ trans('user.edit_admin') }}
			</div>
		   <div class="form-page-content">
			   <div class="inner-content clearfix" data-ng-controller="AdminUserController as adminUserCtrl" data-ng-init = "adminUserCtrl.fetchadminUserSingleInfo({{$id}})">
			         ...
			         <div class="row">
		         		<div class="col-md-12">
                            <div class="form-group" data-ng-class="{'has-error': errors.name.has}">
                                ...
                                <div class="col-md-6">
                                     <input type="text" class="form-control" data-ng-model='adminUserCtrl.adminUser.name' data-validation-name="{{ trans('general.name') }}" name="name">
                            ...
                            <div class="form-group" data-ng-class="{'has-error': errors.mobile_number.has}">
                                ...
                                <div class="col-md-6">
                                     <input type="text" class="form-control" data-validation-name="{{ trans('general.phone_number') }}" name="mobile_number" data-ng-model='adminUserCtrl.adminUser.mobile_number'>
